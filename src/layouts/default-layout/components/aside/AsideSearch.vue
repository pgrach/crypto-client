...
import Results from "@/layouts/default-layout/components/aside/search/Results.vue";
import AsideMain from "@/layouts/default-layout/components/aside/search/Main.vue";
import Empty from "@/layouts/default-layout/components/aside/search/Empty.vue";
import AdvancedOptions from "@/layouts/default-layout/components/aside/search/AdvancedOptions.vue";
import Preferences from "@/layouts/default-layout/components/aside/search/Preferences.vue";
import InlineForm from "@/layouts/default-layout/components/aside/search/InlineForm.vue";
